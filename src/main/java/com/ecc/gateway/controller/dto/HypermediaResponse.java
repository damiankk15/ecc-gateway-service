...
{
    /**
     * Immutable value object representing a single HATEOAS link. Declared as a nested {@code record} so it is co-located with the response it belongs
     * to and carries no state beyond the absolute URL it wraps.
     * 
